            ...
            <div className={styles.pickers}>
                <div className={styles.fontColorPicker}>
                    ...
                    <div className={styles.colorPicker}>
                        <div className={styles.colorPickerVisible}>
                ...
                <div className={styles.fontSizePicker}>
                    <div>
                        <label>Taille de police des titres: </label>
                        <select
                            value={form.theme.font1_size}
                            onChange={(e) =>
                                handleFontSizeChange("font1", e.target.value)
                            }
                            className={styles.fontDropdown}
                        >
                    ...
                    <div>
                        <label>Taille de police des textes: </label>
                        <select
                            value={form.theme.font2_size}
                            onChange={(e) =>
                                handleFontSizeChange("font2", e.target.value)
                            }
                            className={styles.fontDropdown}
                        >
