...
// // import type { FormItem } from '../../types/form'; // Assurez-vous que le chemin est correct
        ...
        <>
            <section className="Item_contenainer">
                ...
                <div className="Item_footer">
                    <Button  variant= "primary"onClick={()=> navigate(`/edit-form/${form.id}`)}>Editer</Button> detail form pour switch vers la page d'édition du formulaire
